            ...
            return (
              <Card key={item.key}>
                ...
                <CardContent className="space-y-3">
                  <div className="text-3xl font-semibold">{metric.used.toLocaleString()} / {metric.limit.toLocaleString()}</div>
              ...
              <Card key={item.name} className={current ? "border-primary" : undefined}>
                <CardHeader>
                  ...
                  <CardDescription className="space-y-2">
                    <span className="block"><span className="text-3xl font-semibold text-foreground">{item.price}</span> / month</span>
